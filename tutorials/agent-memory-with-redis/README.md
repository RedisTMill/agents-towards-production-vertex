...
[![Open In Colab](https://colab.research.google.com/github/RedisTMill/agents-towards-production-vertex/blob/feat/vertex-embeddings/tutorials/agent-memory-with-redis/agent_memory_tutorial.ipynb)
